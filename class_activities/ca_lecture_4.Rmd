...
In this activity, you will practice using `ggplot` to create and customize visualizations. You will use both the `mpg` data from class today, and the `penguins` data from last week. Work in groups to answer the questions below.

## Setup

As with all class activities, there is nothing you will need to submit. However, in case it helps you work on the questions, an R Markdown template is provided for you:
