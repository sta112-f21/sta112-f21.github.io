---
title: "Class Activity, September 27"
output: 
  tufte::tufte_html:
    css: "../labs/lab.css"
...
Download the activity template: [activity template](https://sta112-f21.github.io/class_activities/ca_lecture_16_template.Rmd)

In HW 2, you examined the relationship between Diet and WingLength for the `drosophila` data:
...
3. Use `dplyr` functions to calculate the mean WingLength for each diet in the `drosophila` data. How do your answers compare to question 2?
