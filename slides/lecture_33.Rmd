...
* Quiz 5 next Wednesday
    * Covers up through logistic regression assumptions
* Today:
...
**Putting data:** Put at lengths 3, 4, 5, 6, and 7 feet. Record whether you make the put ( $y = 1$ ) or miss ( $y = 0$ ). Let $\pi = P(y = 1)$.
...
$L(\beta_0, \beta_1) = P(\text{data}) = (0.818)(0.818)(0.731)(1 - 0.622)(1 - 0.378) = 0.115$
...
$(0.818)^3(0.731)^2(0.622)^3(1 - 0.622)^2(0.5)(1 - 0.5)(0.378)(1 - 0.378)^2$
$= 0.000368$
...
| Length | 3 | 4 | 5 | 6 | 7 |
| --- | --- | --- | --- | --- | --- |
| $\pi$ | $\dfrac{\exp\{4 - 0.75(3)\}}{1 + \exp\{3 - 0.5(3)\}} = 0.852$ | 0.731 | 0.562 | 0.378 | 0.223 |

$L(\beta_0, \beta_1) = P(\text{data}) =$
$(0.852)^3(0.731)^2(0.562)^3(1 - 0.562)^2(0.378)(1 - 0.378)(0.223)(1 - 0.223)^2$
$= 0.000356$
...
* **Measure of fit:** $SSE = \sum \limits_{i = 1}^n (y_i - \widehat{\beta}_0 - \widehat{\beta}_1 x)^2$
