...
* $\beta_0$ = mean bill length of Adelie penguins
...
* $\beta_0 + \beta_1$ = mean bill length of Chinstrap penguins
...
* $\beta_0 + \beta_2$ = mean bill length of Gentoo penguins
...
Rule of thumb: not too concerned about constant variance if
