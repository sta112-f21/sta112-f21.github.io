...
$(3) \hspace{1cm} \text{oxygen} = \beta_0 + \beta_1 \text{IsShip} + \beta_2 \text{mass} +$

$\hspace{6cm} \beta_3 \text{IsShip} \cdot \text{mass} +  \varepsilon$
...
$(2) \hspace{1cm} \widehat{\text{oxygen}} = 143.72 + 53.68 \ \text{IsShip} +$

$\hspace{6cm}  0.05 \ \text{mass}$

\vspace{0.5cm}

$(3) \hspace{1cm} \widehat{\text{oxygen}} = 52.06 + 257.38 \ \text{IsShip} +$

$\hspace{6cm} 1.92 \ \text{mass} - 4.05 \ \text{IsShip} \cdot \text{mass}$
