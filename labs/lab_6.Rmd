...
11. Calculate and interpret a confidence interval for the interaction parameter, $\beta_5$, in the model in Equation 2.
...
15. Since there are a few potential outliers, try removing these outliers and re-fit both the models in Equation 2 and Equation 1. Re-calculate the p-value as in Exercise 7, and the confidence interval as in Exercise 11. Do your conclusions about the research question change after removing outliers?